...
function tms9918(canvas)
{
    ...
    this.m_rgbBluePalette = [ 0, 0, 32, 96, -32, -32, 32, -32, 32, 96,
				       32, -128, 32, -96, -96, -32 ];
    //private IndexColorModel modeloCores;
    //private IndexColorModel modeloCores2;
    this.atualizaTodaTela = true;
    this.regStatus = 0;
    ...
    //private MemoryImageSource memoriaTela;
    //private Image tela;
    
//    this.tms9128 = function(canvas) {
 	this.canvas.fillStyle = "rgba("+this.cor[0][0]+","+this.cor[0][1]+","+this.cor[0][2]+",255)";
